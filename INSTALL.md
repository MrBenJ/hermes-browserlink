...
> other **web** tab in this browser profile (only public `http:`/`https:`
> hosts are capturable; browser-internal, extension, `file://` and
> loopback/LAN/link-local tabs are excluded).
